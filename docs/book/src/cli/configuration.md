...
For an explanation of the schema defined at the top of `languages.ncl`, see the Nickel documentation's explanation of [_Contracts in Nickel_](https://nickel-lang.org/user-manual/contracts/)
